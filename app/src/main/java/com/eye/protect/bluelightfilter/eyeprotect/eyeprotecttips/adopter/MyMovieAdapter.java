package com.eye.protect.bluelightfilter.eyeprotect.eyeprotecttips.adopter;
...
import com.eye.protect.bluelightfilter.eyeprotect.eyeprotecttips.Eyeprotectmain;
...
public class MyMovieAdapter extends RecyclerView.Adapter<MyMovieAdapter.ViewHolder> {
    ...
    public MyMovieAdapter(MyMovieData[] myMovieData, Eyeprotectmain activity) {
